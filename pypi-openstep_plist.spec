...
Source0  : https://files.pythonhosted.org/packages/1e/01/e55052a0abf3b527e199c440fba4eeacd647fe14a31ed076ce17daccc28f/openstep_plist-0.5.0.tar.gz
...
%prep
%setup -q -n openstep_plist-0.5.0
cd %{_builddir}/openstep_plist-0.5.0
pushd ..
cp -a openstep_plist-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738271461
